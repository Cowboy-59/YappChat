# Quickstart: Authenticated App Shell + Dashboard

**Spec Number**: 068

## Setup

1. Review the spec: `specs/068-authenticated-app-shell-+-dashboard/spec.md`
...
1. Run `/scope-validate 068` to check spec quality

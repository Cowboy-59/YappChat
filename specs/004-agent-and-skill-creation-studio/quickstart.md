# Quickstart: Agent and Skill Creation Studio

**Spec Number**: 004

## Setup

1. Review the spec: `specs/004-agent-and-skill-creation-studio/spec.md`
...
1. Run `/scope-validate 004` to check spec quality

# Quickstart: Mobile Shell and App Packaging

**Spec Number**: 008

## Setup

1. Review the spec: `specs/008-mobile-shell-and-app-packaging/spec.md`
...
1. Run `/scope-validate 008` to check spec quality
